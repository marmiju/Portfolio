...
const Content = () => {
    return (
        <div className=" w-3/4 p-4 mx-auto flex flex-col justify-center items-center md:mt-60 md:items-start ">
            <h1 className=' text-xl md:text-3xl poppins text-[#737171] font-normal'>Hello I'm
            </h1>
